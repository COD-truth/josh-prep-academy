...
export const translations = {
  ...
  hero: {
    badge: { fr: "Inscriptions ouvertes · Promotion 2026", en: "Now enrolling · Class of 2026" },
    title1: { fr: "L'excellence académique au service de votre", en: "Academic excellence in service of your" },
    title2: { fr: "réussite", en: "success" },
    subtitle: {
      fr: "Sous la direction du Dr. Josh, préparez vos concours d'entrée aux grandes universités professionnelles avec une équipe de tuteurs d'élite.",
      en: "Under Dr. Josh's guidance, prepare for entrance exams to top professional universities with a team of elite tutors.",
    },
    cta1: { fr: "Réserver un créneau", en: "Book a slot" },
    cta2: { fr: "Découvrir la banque d'épreuves", en: "Explore the exam bank" },
    stat1: { fr: "Taux de réussite", en: "Success rate" },
    stat1v: { fr: "98% concours 2024", en: "98% exams 2024" },
  },
  subjects: {
